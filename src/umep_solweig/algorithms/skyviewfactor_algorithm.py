...
class ProcessingSkyViewFactorAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return self.tr(
            ...
            "\n"
            "Sky View Factor supports GPU acceleration via PyTorch for faster calculations. "
            "Performance gains are most significant for high-resolution input data or large geographic areas (over a few km²). "
            "It requires a compatible NVIDIA or Intel graphics or AMD (with ROCM) card with up-to-date drivers. "
            "If out-of-memory errors occur on large datasets, disable acceleration or tile your input data. "
            "The system is fully backward compatible and automatically falls back to CPU if hardware or PyTorch is missing.\n"
            "\n"
            "-------------\n"
